...
for i = 482:482
    ...
    [I1r, I2r, bb1, bb2, Pn1, Pn2]  = doRectify(image_path0, image_path1,true);
    ...
    fprintf(f, 'Rect.R = %f %f %f %f %f %f %f %f %f\n', Rn1_t(1,1), Rn1_t(1,2), Rn1_t(1,3), Rn1_t(2,1), Rn1_t(2,2), Rn1_t(2,3), Rn1_t(3,1), Rn1_t(3,2), Rn1_t(3,3));
    fprintf(f, 'Rect.t = %f %f %f\n', c1(1), c1(2), c1(3));
